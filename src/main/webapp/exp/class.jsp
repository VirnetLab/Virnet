                ...
                <div class="col-md-2">
               		<div class="sidebar-nav">
                        <ul class="nav nav-list nav-new">
                            ...
                            <li class="sidebar-active" onclick="sidebar_click(this)"><a href="exp/class.jsp">班级管理</a></li>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody id="tbody">
                                <tr>
                                    <td>0</td>
                                    <td><button class="btn btn-link" onclick="Detail(this)">计算机网络 1班</button></td>
                                    <td><button class="btn btn-link" onclick="Edit_Homepage(this);">编辑</button></td>
                                </tr>
                                <tr>
                                    <td>1</td>
                                    <td><button class="btn btn-link" onclick="Detail(this)">计算机网络 2班</button></td>
                                    <td><button class="btn btn-link" onclick="Edit_Homepage(this);">编辑</button></td>
                                </tr>
                                <tr>
                                    <td>2</td>
