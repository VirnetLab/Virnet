                ...
                <div class="col-md-2">
               		<div class="sidebar-nav">
                        <ul class="nav nav-list nav-new">
                            <li class="sidebar-nonactive" onclick="sidebar_click(this)"><a href="exp/course.jsp">课程管理</a></li>
                            <li class="sidebar-nonactive" onclick="sidebar_click(this)"><a href="exp/class.jsp">班级管理</a></li>
                            <li class="sidebar-active" onclick="sidebar_click(this)"><a href="exp/exp.jsp">实验管理</a></li>
       ...
       <div class="modal-dialog">
          <div class="modal-content">
             ...
             <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="inputsave();">
                   保存
                </button>
             </div>
          </div><!-- /.modal-content -->
